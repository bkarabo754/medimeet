            ...
            <div className="space-y-6 py-4">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-muted/20 p-4 rounded-lg border border-red-900/20 space-y-3">
                  ...
                  <div className="border-t border-red-900/20 pt-3 flex justify-between font-medium">
        ...
        >
          <DialogContent>
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="bg-muted/20 p-4 rounded-lg border border-red-900/20">
            ...
            {loading && <BarLoader width={'100%'} color="#d73636" />}
